...
export const Timeline = ({ data }) => {
  ...
  // Colors to be used for the titles and background circles
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-white font-semibold dark:text-white max-w-4xl">
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            ...
            >
              ...
              >
                <div
                  className="h-4 w-4 rounded-full bg-white dark:bg-white border border-white dark:border-white p-2"
                />
              </div>
              <h3
