...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className={cn(
        "absolute flex h-[auto] w-full items-center justify-center overflow-hidden rounded-lg border bg-transperent p-10 md:shadow-xl",
      )}
      ref={containerRef}
    >
...
const Icons = {
  azure: () => (
    <img
    src="/images/azure.png" // path relative to the public folder
    alt="Python Icon"
    width="100"
    height="100"
  />
  ...
  openai: () => (
    <img
    src="/images/brain.png" // path relative to the public folder
    alt="Python Icon"
    width="100"
    height="100"
  />
  ...
  python: () => (
    <img
    src="/images/python.png" // path relative to the public folder
    alt="Python Icon"
    width="100"
    height="100"
  />
  ...
  tensorflow: () => (
    <img
    src="/images/tensorflow.png" // path relative to the public folder
    alt="Python Icon"
    width="100"
    height="100"
  />
